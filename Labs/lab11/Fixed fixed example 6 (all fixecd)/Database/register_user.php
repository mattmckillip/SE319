<?php
	...
	$sql="INSERT INTO users (Groupnumber, Username, Password, Email, Phone, Librarian, Firstname, Lastname)
		VALUES ('31', "."'".mysql_real_escape_string($username)."'".", '$password', '".mysql_real_escape_string($email)."', '".mysql_real_escape_string($phone)."', '$librarian', '".mysql_real_escape_string($first)."', '".mysql_real_escape_string($last)."')";
