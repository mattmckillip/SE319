...
<body>
	...
	<?php
		...
		$book_loc = htmlentities($_GET,  ENT_QUOTES,  "utf-8"); 
		...
		if(isset($student))
		{
			...
			{
				echo "<a href=\"book_details.php?shelf=".htmlentities($book_loc['shelf'],ENT_QUOTES,"utf-8")."&book=".htmlentities($book_loc['book'],ENT_QUOTES,"utf-8")."&return=1\">Return Book</a>";
			}
			else
			{
